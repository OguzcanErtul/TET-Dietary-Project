...
public class DietaryDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=DESKTOP-HL6R8FL\\" +
            "SQLEXPRESS;Database=EF_Dietary;Trusted_Connection=True;Encrypt=" +
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AppUser>()
            ...
            .HasForeignKey<AppUserDetail>(ad => ad.AppUserId); 
